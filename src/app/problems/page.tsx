...
import { Coins, Flame, TrendingUp, Clock, ChevronRight } from "lucide-react"
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-400">
                    ...
                    <span className="flex items-center gap-1">
                      <Clock className="w-3 h-3" /> {problem.timeLeft}
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-medium">{problem.reward}</span>
                  </div>
                  <Link
